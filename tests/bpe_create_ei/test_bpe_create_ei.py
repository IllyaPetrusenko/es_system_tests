...
class TestBpeCreateEI(object):
    ...
    #     assert create_ei_response[1]['errors'][0]['code'] == '400.10.00'
    #     assert create_ei_response[1]['errors'][0]['description'] == f"com.fasterxml.jackson.databind.JsonMapping' \
    #                                                                 'Exception: Text '{startDate}' could not be " \
    ...
    #                                                                 f"model.dto.ei.request.PlanningEiCreate" \
    #                                                                 f"[\"budget\"]->com.procurement.budget.model." \
    #                                                                 f"dto.ei.request.BudgetEiCreate[\"period\"]->" \
    #                                                                 f"com.procurement.budget.model.dto.ocds." \
    #                                                                 f"Period[\"startDate\"])"
    ...
    #                                                                f"Exception: Text '2019.02.08T00:00:00Z' could " \
    #                                                                f"not be parsed at index 4 (through reference " \
    #                                                                f"chain: com.procurement.budget.model.dto.ei." \
    #                                                                f"request.EiCreate[\"planning\"]->com.procurement" \
    #                                                                f".budget.model.dto.ei.request.PlanningEi" \
    #                                                                f"Create[\"budget\"]->com.procurement.budget." \
    #                                                                f"model.dto.ei.request.BudgetEiCreate" \
    ...
    def test_22172_2(self):
        ...
        assert create_ei_response[1]['errors'][0]['description'] == f"com.fasterxml.jackson.databind.JsonMapping" \
                                                                    ...
                                                                    f"parsed: Invalid value for MonthOfYear " \
                                                                    f"(valid values 1 - 12): 32 (through reference " \
                                                                    f"chain: com.procurement.budget.model.dto." \
                                                                    f"ei.request.EiCreate[\"planning\"]->com." \
                                                                    f"procurement.budget.model.dto.ei.request." \
                                                                    f"PlanningEiCreate[\"budget\"]->com.procurement." \
                                                                    f"budget.model.dto.ei.request.BudgetEiCreate" \
                                                                    f"[\"period\"]->com.procurement.budget.model." \
                                                                    f"dto.ocds.Period[\"endDate\"])"