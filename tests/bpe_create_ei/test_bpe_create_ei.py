...
class TestCheckOnTheImpossibilityToCreateEiWithInvalidDataType(object):
    ...
    #         actual_result = str(create_ei_response.status_code)
    #         expected_result = str(202)
    #         assert compare_actual_result_and_expected_result(expected_result=expected_result, actual_result=
    #         actual_result)
    #
    #     @pytestrail.case("22136")
    ...
    #         ei_url = message_from_kafka["data"]["url"] + "/" + cpid
    #         ei_release = requests.get(url=ei_url).json()
    #         actual_result_country_scheme = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["country"][
    #             "scheme"]
    ...
    #         ei_url = message_from_kafka["data"]["url"] + "/" + cpid
    #         ei_release = requests.get(url=ei_url).json()
    #         actual_result_country_uri = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["country"][
    #             "uri"]
    ...
    #         ei_url = message_from_kafka["data"]["url"] + "/" + cpid
    #         ei_release = requests.get(url=ei_url).json()
    #         actual_result_region_scheme = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["region"][
    #             "scheme"]
    ...
    #         ei_url = message_from_kafka["data"]["url"] + "/" + cpid
    #         ei_release = requests.get(url=ei_url).json()
    #         actual_result_region_uri = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["region"][
    #             "uri"]
    ...
    #         expected_result_locality_id = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["locality"][
    #             "id"]
    ...
    #         ei_url = message_from_kafka["data"]["url"] + "/" + cpid
    #         ei_release = requests.get(url=ei_url).json()
    #         actual_result_locality_id = ei_release["releases"][0]["parties"][0]["address"]["addressDetails"]
    #         ["locality"][
    #             "id"]
    ...
    #                                                "REGIONAL_AUTHORITY, REGIONAL_AGENCY, BODY_PUBLIC,
    #                                                EU_INSTITUTION, "
    #                                                "MINISTRY]\n at [Source: UNKNOWN; line: -1, column: -1] (through "
    #                                                "reference chain: com.procurement.mdm.model.dto.data.ei.EIRequest"
    ...
    #                                                          actual_result=ei_release["releases"][0]["planning"]
    #                                                          ["budget"][
    #                                                              "id"])
    #         assert compare_actual_result_and_expected_result(expected_result=expected_result, actual_result=
    #         actual_result)
    ...
    #
    #     @pytestrail.case("22165")
    #     def test_check_the_planning_budget_startDate_and_planning_budget_endDate_in_the_EI_record_22165_3
    #     (self, country,
    #                                                                                                       language):
    #         budget_period = get_period()
    #         payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    #         assert compare_actual_result_and_expected_result(expected_result=str(True), actual_result=str
    #         (actual_result))
    #
    #
    ...
    #                                 "description": f"com.fasterxml.jackson.databind.JsonMappingException: "
    #                                                f"Text '{end_date}' could not be parsed: Invalid value for "
    #                                                f"MonthOfYear (valid values 1 - 12): 13 (through reference
    #                                                chain: "
    #                                                f"com.procurement.budget.model.dto.ei.request.EiCreate
    #                                                [\"planning\"]"
    #                                                f"->com.procurement.budget.model.dto.ei.request.EiCreate$"
    ...
    #
    #     @pytestrail.case("22173")
    #     def test_check_the_tender_classification_id_has_the_value_sent_in_the_request_22173_3(self, country,
    #     language):
    #         payload = copy.deepcopy(payload_ei_full_data_model)
    #         payload["tender"]["classification"]["id"] = "45100000-8"
    #         ei = EI(payload=payload, lang=language, country=country)
    ...
    #
    #     @pytestrail.case("22841")
    #     def test_check_the_attribute_in_parties_address_addressDetails_country_scheme_22841_3(self, country,
    #     language):
    #         payload = copy.deepcopy(payload_ei_full_data_model)
    #         payload["buyer"]["address"]["addressDetails"]["country"]["id"] = "MD"
    #         ei = EI(payload=payload, lang=language, country=country)
    ...
    #         actual_result = ei_record["records"][0]["compiledRelease"]["parties"][0]["address"]["addressDetails"][
    #             "country"]["scheme"]
    #         assert compare_actual_result_and_expected_result(expected_result="iso-alpha2", actual_result=
    #         actual_result)
    #
    #
    ...
    #
    #     @pytestrail.case("22842")
    #     def test_check_the_attribute_in_parties_address_addressDetails_country_description_22842_3(self,
    #     country, language):
    #         payload = copy.deepcopy(payload_ei_full_data_model)
    #         payload["buyer"]["address"]["addressDetails"]["country"]["id"] = "MD"
    #         ei = EI(payload=payload, lang=language, country=country)
    ...
    #                                                          actual_result=ei_release["releases"][0]["tender"][
    #                                                              "items"][0]["unit"]["name"])
    #         assert compare_actual_result_and_expected_result(expected_result=payload["tender"]["items"][0]
    #         ["unit"]["id"],
    #                                                          actual_result=ei_release["releases"][0]["tender"][
    #                                                              "items"][0]["unit"]["id"])
    #
    ...
    #
    #
    # class TestCheckOnImpossibiltyToCreateEiIfDeliveryAddressAddressDetailsLocalityIdIsNotRelatedToValueOf
    # RegionId(object):
