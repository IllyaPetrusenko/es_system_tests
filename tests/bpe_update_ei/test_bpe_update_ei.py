...
class TestBpeCreateEI(object):
    ...
    # @pytestrail.case('23902')
    # def test_23902_1(self):
    #     ei_create = copy.deepcopy(ei_full)
    #     ei_create['tender']['classification']['description'] = 'desc1'
    #     create_ei_response = bpe_create_ei(ei_create)
    #
    #     ei_update = copy.deepcopy(ei_update_full)
    #     ei_update['tender']['classification']['description'] = 'desc2'
    #     access_token = get_access_token_for_platform_one()
    #     x_operation_id = get_x_operation_id(access_token)
    #
    #     time.sleep(2)
    ...
    #     assert message_from_kafka['X-OPERATION-ID'] == x_operation_id
    #     assert ocid == True
    #     assert publicPoint_update_ei['releases'][0]['tender']['classification']['description'] == \
    #            publicPoint_create_ei['releases'][0]['tender']['classification']['description']
