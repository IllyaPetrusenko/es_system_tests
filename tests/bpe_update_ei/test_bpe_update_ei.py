...
from useful_functions import compare_actual_result_and_expected_result, get_access_token_for_platform_two, get_period, \
    get_new_period, is_valid_uuid
...
class TestCheckOnImpossibilityUpdateEiIfOwnerFromRequestNotEqualOwnerFromDB(object):
    ...
    def test_send_the_request_24444_1(self, country, language):
        payload = copy.deepcopy(payload_ei_obligatory_data_model)
        ei = EI(payload=payload, lang=language, country=country, access_token=get_access_token_for_platform_two())
        ei.insert_ei_full_data_model()
        update_ei_response = ei.update_ei()
        expected_result = str(202)
        actual_result = str(update_ei_response.status_code)
...
class TestCheckOnImpossibilityUpdateEiIfTenderClassificationIdNotEqualTenderItemsClassificationId(object):
    ...
    def test_send_the_request_24445_1(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24445")
    def test_see_the_result_in_feed_point_24445_2(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
        payload['tender']['classification']['id'] = "90900000-6"
        payload['tender']['items'] = [{
            "id": "1",
...
class TestCheckOnImpossibilityToUpdateSomeAttributesInEiRelease(object):
    ...
    def test_compare_data_of_EI_release_before_updating_and_after_updating_24449_3(self, country, language):
        ...
        assert compare_actual_result_and_expected_result(
            expected_result=
            ei_release_before_updating["releases"][0]["parties"][0]["address"]["addressDetails"]["locality"]["scheme"],
            actual_result=
...
class TestCheckOnPossibilityUpdateTenderItemsDeliveryAddressInEiRelease(object):
    ...
    def test_send_the_request_24453_1(self, country, language):
        ...
        payload['tender']['items'][0]['deliveryAddress']['addressDetails']['region']['description'] = "description_44_2"
        ...
        ei = EI(payload=payload, lang=language, country=country, tender_items_delivery_street="Khreshchatyk",
                ...
                tender_items_delivery_details_region_id="0101000", tender_items_delivery_details_locality_id="0101000",
...
class TestCheckOnImpossibilityUpdateEiWithoutObligatoryFieldsInPayload(object):
    ...
    def test_delete_tender_object_from_the_payload_24456_1(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
        del payload["tender"]
        ei = EI(payload=payload, lang=language, country=country)
        ei.insert_ei_full_data_model()
    ...
    @pytestrail.case("24456")
    def test_delete_tender_title_field_from_the_payload_24456_2(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_id_field_from_the_payload_24456_3(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_description_field_from_the_payload_24456_4(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_classification_field_from_the_payload_24456_5(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_classification_id_field_from_the_payload_24456_6(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_field_from_the_payload_24456_9(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_country_field_from_the_payload_24456_10(self, country,
                                                                                                        language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_country_id_field_from_the_payload_24456_11(self,
                                                                                                           country,
                                                                                                           language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_region_field_from_the_payload_24456_12(self,
                                                                                                       country,
                                                                                                       language):
        payload = copy.deepcopy(payload_ei_full_data_model)
        ...
        expected_result = str([{"code": "400.20.00",
                                "description": "com.fasterxml.jackson.module.kotlin.MissingKotlinParameter"
                                               ...
                                               "missing (therefore NULL) value for creator parameter region which "
                                               "is a non-nullable type\n at [Source: UNKNOWN; line: -1, column: -1] "
                                               "(through reference chain: com.procurement.mdm.model.dto.data.ei."
                                               "EIRequest[\"tender\"]->com.procurement.mdm.model.dto.data.ei."
                                               "EIRequest$Tender[\"items\"]->java.util.ArrayList[0]->com."
                                               ...
                                               "procurement.mdm.model.dto.data.ei.EIRequest$Tender$Item$"
                                               "DeliveryAddress$AddressDetails[\"region\"])"}])
        assert compare_actual_result_and_expected_result(expected_result=expected_result, actual_result=actual_result)

    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_region_id_field_from_the_payload_24456_13(self,
                                                                                                          country,
                                                                                                          language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_locality_id_field_from_the_payload_24456_14(self,
                                                                                                            country,
                                                                                                            language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("24456")
    def test_delete_tender_items_deliveryAddress_addressDetails_locality_id_field_from_the_payload_24456_15(self,
                                                                                                            country,
                                                                                                            language):
        payload = copy.deepcopy(payload_ei_full_data_model)
...
class TestCheckTheFieldsWithEmptyStringsAreNotPublishedInThePublicPoint(object):
    ...
    @pytestrail.case("25300")
    def test_delete_tender_items_deliveryAddress_streetAddress_field_from_the_payload_25300_4(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("25300")
    def test_delete_tender_items_addressDetails_locality_scheme_field_from_the_payload_25300_5(self, country,
                                                                                               language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("25300")
    def test_delete_tender_items_addressDetails_locality_id_field_from_the_payload_25300_6(self, country,
                                                                                           language):
        payload = copy.deepcopy(payload_ei_full_data_model)
    ...
    @pytestrail.case("25300")
    def test_delete_tender_items_addressDetails_locality_description_field_from_the_payload_25300_7(self, country,
                                                                                                    language):
        payload = copy.deepcopy(payload_ei_full_data_model)
        payload["tender"]["items"][0]["deliveryAddress"]["addressDetails"]["locality"]["scheme"] = "other"
    ...
    @pytestrail.case("25300")
    def test_delete_tender_items_description_field_from_the_payload_25300_7(self, country, language):
        payload = copy.deepcopy(payload_ei_full_data_model)
