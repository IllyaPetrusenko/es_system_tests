...
section_id = sections_id[4]["id"]

cases = client.send_get(f'/get_cases/13&suite_id={suite_id}&section_id={section_id}&filter={type_of_case}')
li = []
for case in cases:
    case_ids = case['id']
    li.append(case_ids)
...
post_body = {
    "suite_id": suite_id,
        "name": "BPE: create pn (open) (This is a new test run for automation)",
    "include_all": False,
    "case_ids": li
