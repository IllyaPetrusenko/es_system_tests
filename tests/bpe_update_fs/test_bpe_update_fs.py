...
class TestCheckOnCorrectnessOfUpdatingFsTreasuryObligatoryDataModelToTreasuryObligatoryDataModel(object):
    ...
    def test_send_the_request_27559_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
        payload = copy.deepcopy(update_fs_payload_fs_obligatory_data_model_treasury_money)
    ...
    @pytestrail.case("27559")
    def test_see_the_result_in_feed_point_point_27559_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
...
class TestCheckOnCorrectnessOfUpdatingFsTreasuryFullDataModelToTreasuryFullDataModel(object):
    @pytestrail.case("27561")
    def test_send_the_request_27561_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27561")
    def test_see_the_result_in_feed_point_point_27561_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27561")
    def test_check_on_correctness_of_publishing_fs_27561_3(self, country, language, instance, cassandra_username,
                                                           cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
        ...
        assert compare_actual_result_and_expected_result(
            expected_result=parties_obj_before_update[0]["address"]["addressDetails"]["locality"]["uri"],
            actual_result=parties_obj_after_update[0]["address"]["addressDetails"]["locality"]["uri"]
        )
        assert compare_actual_result_and_expected_result(
...
class TestCheckOnCorrectnessOfUpdatingFsTreasuryObligatoryDataModelToTreasuryFullDataModel(object):
    @pytestrail.case("27562")
    def test_send_the_request_27562_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
        ...
        create_fs_response = fs.insert_fs_treasury_obligatory_ei_full_without_items(
            cp_id=cp_id,
            ei_token=ei_token
        )
        update_fs_response = fs.update_fs(
    ...
    @pytestrail.case("27562")
    def test_see_the_result_in_feed_point_point_27562_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27562")
    def test_check_on_correctness_of_publishing_fs_27562_3(self, country, language, instance, cassandra_username,
                                                           cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
...
class TestCheckOnCorrectnessOfUpdatingFsTreasuryFullDataModelToTreasuryObligatoryDataModel(object):
    @pytestrail.case("27563")
    def test_send_the_request_27563_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
        ...
        create_fs_response = fs.insert_fs_treasury_full_ei_obligatory_with_items(
            cp_id=cp_id,
            ei_token=ei_token
        )
        update_fs_response = fs.update_fs(
    ...
    @pytestrail.case("27563")
    def test_see_the_result_in_feed_point_point_27563_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27563")
    def test_check_on_correctness_of_publishing_fs_27563_3(self, country, language, instance, cassandra_username,
                                                           cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
...
class TestCheckOnCorrectnessOfUpdatingFsOwnObligatoryDataModelToOwnObligatoryDataModel(object):
    @pytestrail.case("27564")
    def test_send_the_request_27564_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27564")
    def test_see_the_result_in_feed_point_point_27564_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27564")
    def test_check_on_correctness_of_publishing_fs_27564_3(self, country, language, instance, cassandra_username,
                                                           cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
...
class TestCheckOnCorrectnessOfUpdatingFsOwnFullDataModelToOwnFullDataModel(object):
    @pytestrail.case("27565")
    def test_send_the_request_27565_1(self, country, language, instance, cassandra_username,
                                      cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27565")
    def test_see_the_result_in_feed_point_point_27565_2(self, country, language, instance, cassandra_username,
                                                        cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
    ...
    @pytestrail.case("27565")
    def test_check_on_correctness_of_publishing_fs_27565_3(self, country, language, instance, cassandra_username,
                                                           cassandra_password):
        date = get_new_period()
        cp_id = prepared_cp_id()
        ei_token = str(uuid4())
